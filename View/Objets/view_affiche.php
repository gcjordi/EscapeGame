...
<div id="affiche_releve" style="display: none;">
      ...
      width: 60vh;
      color:white;">
            <img alt="img" style="width: 60vh; position: absolute;" src="View/IMG/RelevéVrai.PNG" id="affiche8" object='<?= json_encode(['id' => 'afficheRele', 'nom' => 'Affiche relevé de compte', 'img' => "View/IMG/RelevéVrai.PNG", "open" => "affiche_releve", "remove"=>"mini_affiche_releve"]) ?>' ondragstart="drag(event)">
      </div>
</div>
...
<div id="clef" style="display: none;">
      ...
      width: 40vh;
      color:white;">
            <img alt="img" style="width: 40vh; position: absolute;" src="View/IMG/inventaire/clef.png" id="affiche_clef" object='<?= json_encode(['id' => 'afficheClef', 'nom' => 'Une clé', 'img' => "View/IMG/inventaire/clef.png", "open" => "clef", "remove"=>"mini_clef"]) ?>' ondragstart="drag(event)">
      </div>
</div>
