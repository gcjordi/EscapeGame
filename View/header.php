<header>
    ...
    <div class="right col-7">
        <a class="item degrade_halloween" href="classement.php">
            <p class="item_title">Classement</p>
        </a>
        <?php if(!isset($_SESSION["user_connected"])): ?>
        <a class="item degrade_halloween" href="inscription.php">
            <p class="item_title">Inscription</p>
        </a>
        <a class="item degrade_halloween" href="connexion.php">
            <p class="item_title">Connexion</p>
        </a>
        <?php endif;
        if (isset($_SESSION["user_connected"])): ?>
        <a class="item degrade_halloween" href="profil.php">
