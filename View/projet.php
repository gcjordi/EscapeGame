...
<div class="container">
    ...
    <p class="textegris"> Réalisé par Samuel ROBINET - Adrien SEGURA - William DONNETTE - Santiago MARTINEZ </p>
    <p class="textegris"> Sous la direction de Antoine CHOLLET </p>
    <div class="boxbas">
