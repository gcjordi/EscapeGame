...
<div id="container" style="background: #64fa7f; width: 100%; height: 100%">
    ...
    <div id="container_blocnote" style="position: fixed; bottom: 5vh; right: 5vw; width: 6vh; height: 6vh; border-radius: 6vh; background: white; display: flex; flex-direction: column; justify-content: space-between; align-items: center; z-index: 10000; padding: 3vh">
        <div id="blocnote" style="display: none; width: 20vw; height: 20vh">
            <textarea style="height: 20vh; width: 20vw"></textarea>
        </div>
        <div class="show_bloc" style="width: 6vh; height: 6vh; display: flex; flex-direction: row; justify-content: flex-end; align-items: center; cursor: pointer">
